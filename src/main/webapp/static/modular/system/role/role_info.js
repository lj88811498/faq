...
RolInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Feng.ctxPath + "/sysRole/edit", function (data) {
        Feng.success("修改成功!");
        window.parent.Role.table.refresh();
        RolInfoDlg.close();
    }, function (data) {
...
$(function () {
    ...
    var deptTree = new $ZTree("deptTree", "/sysDept/tree");
    ...
    var pNameTree = new $ZTree("pNameTree", "/sysRole/roleTreeList");
