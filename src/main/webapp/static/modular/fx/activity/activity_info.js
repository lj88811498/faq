...
ActivityCaseInfoDlg.collectData = function() {
    ...
    .set('activityCaseType')
    .set('activityCaseCreateBy')
    .set('activityCaseUpdateBy')
    .set('activityCaseUpdateTime')
    ;
}
...
ActivityCaseInfoDlg.addSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(Feng.ctxPath + "/activityCase/add", function(data){
        Feng.success("添加成功!");
...
ActivityCaseInfoDlg.editSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(Feng.ctxPath + "/activityCase/update", function(data){
        Feng.success("修改成功!");
        window.parent.ActivityCase.table.refresh();
        ActivityCaseInfoDlg.close();
    },function(data){
