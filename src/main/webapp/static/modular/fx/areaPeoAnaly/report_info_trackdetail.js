...
$(function () {
    trackDetail.mapInit();
    var gridTrailId = window.parent.$("#gridTrailId").data('id');
    var defaultColunms = trackDetail.initColumn();
    var table = new BSTable(trackDetail.id, "/areaPeoAnaly/findReportInfoTrackDetail?gridTrailId=" + gridTrailId, defaultColunms);
