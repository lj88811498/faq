...
(function () {
            ...
            this.btInstance =
                $('#'+tableId).bootstrapTreeTable({
                 ...
                 //   method: method || this.method,		//ajax方式,post还是get
                    ...
                    type: method || this.method, //请求数据的ajax类型
    ...
    var BSTreeTableCC = function (bstableId, url, columns) {
        this.btInstance = null;					//jquery和bootstrapTreeTable绑定的对象
        this.bstableId = bstableId;
        this.url = Feng.ctxPath + url;
        this.method = "post";
    ...
    window.BSTreeTableCC = BSTreeTableCC;
}());