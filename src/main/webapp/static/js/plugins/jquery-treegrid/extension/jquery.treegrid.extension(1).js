...
(function($) {
    ...
    $.fn.bootstrapTreeTable1 = function(options, param) {
        // 如果是调用方法
        if (typeof options == 'string') {
            return $.fn.bootstrapTreeTable1.methods[options](this, param);
        }

        // 如果是初始化组件
        options = $.extend({}, $.fn.bootstrapTreeTable1.defaults, options || {});
        // 是否有radio或checkbox
    ...
    // 组件方法封装........
    $.fn.bootstrapTreeTable1.methods = {
    ...
    $.fn.bootstrapTreeTable1.defaults = {
        id : 'id',// 选取记录返回的值
        code : 'code',// 用于设置父子关系
