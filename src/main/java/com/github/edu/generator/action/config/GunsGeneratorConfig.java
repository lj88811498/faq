package com.github.edu.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.youedata.edu.admin.common.persistence.model");
        packageConfig.setMapper("com.youedata.edu.admin.common.persistence.dao");
        packageConfig.setXml("com.youedata.edu.admin.common.persistence.dao.mapping");
        packageConfig.setParent(null);

        packageConfig.setEntity("com.youedata.edu.dataDir.entity");
        packageConfig.setMapper("com.youedata.edu.dataDir.mapper");
        packageConfig.setXml("mapper");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.youedata.edu.admin");
        contextConfig.setCoreBasePackage("com.youedata.edu.core");
