package com.github.edu.generator.engine.config;
...
//    private String proPackage = "com.youedata.edu.admin";
//    private String coreBasePackage = "com.youedata.edu.core";
//    private String modelPackageName = "com.youedata.edu.modular.system.model";        //model的包名
//    private String modelMapperPackageName = "com.youedata.edu.modular.system.dao";    //model的dao
    private String proPackage = "com.github.edu";
    private String coreBasePackage = "com.github.edu.core";
    private String modelPackageName = "com.github.edu.modular.edu";        //model的包名
    private String modelMapperPackageName = "com.github.edu.modular";    //model的dao
...
//        modelMapperPackageName = proPackage + "." + "modular.system.dao";
        modelPackageName = proPackage + "." + "modular.edu.model";
        modelMapperPackageName = proPackage + "." + "modular.system.dao";
    }

    public ContextConfig(String projectPath, String bizChName, String bizEnName, String moduleName, String entityName, String author) {
        setProjectPath(projectPath);
        setBizChName(bizChName);
        setBizEnName(bizEnName);
        setBizEnBigName(entityName);
