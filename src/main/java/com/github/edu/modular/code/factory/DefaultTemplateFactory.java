package com.github.edu.modular.code.factory;


import com.github.edu.EduApplication;
import com.github.edu.core.CoreFlag;
 ...
 */
public class DefaultTemplateFactory {//test
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("lixin");
        genQo.setProjectPackage(EduApplication.class.getPackage().getName());
